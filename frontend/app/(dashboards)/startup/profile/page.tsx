  ...
  return (
    <main className="flex-1">
      ...
      <section className="p-6 md:p-10 max-w-2xl space-y-6">
        ...
        {!loading && (
          <>
            <div className="mt-8 rounded-[var(--radius)] border border-[var(--border)] bg-[var(--bg-card)] p-6 space-y-5 max-w-2xl">
            ...
            <div className="mt-6 rounded-[var(--radius)] border border-[var(--border)] bg-[var(--bg-card)] p-6 space-y-5 max-w-2xl">
