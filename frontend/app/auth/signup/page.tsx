  ...
  return (
    <div className="relative flex min-h-[calc(100vh-88px)] items-center justify-center px-5 py-10">
      ...
      >
        ...
        <div className="block text-sm space-y-1 text-[var(--text)]">
          <span className="font-sans text-[11px] uppercase tracking-wider text-[var(--text-muted)]">
            Password
          </span>
          <div className="relative">
            <input
              className="input-metatron w-full pr-10"
              value={password}
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 flex items-center px-3 text-[var(--text-muted)] hover:text-[var(--text)] transition-colors"
