...
impl AppState {
    pub async fn initialise(settings: &Settings) -> Result<Arc<Self>, sqlx::Error> {
        ...
        Ok(Arc::new(Self {
            ...
            platform_bot_secret: settings.platform_bot_secret.clone(),
            ...
            internal_automation_token: settings.internal_automation_token.clone(),
            ...
            paystack_connector_plan_basic_monthly: settings
            ...
            nowpayments_api_base: settings.nowpayments_api_base.clone(),
