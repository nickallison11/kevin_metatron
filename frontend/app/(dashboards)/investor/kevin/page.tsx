...
export default function InvestorKevinPage() {
      ...
      <section className="p-6 md:p-10 max-w-5xl mx-auto space-y-8">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--text-muted)]">
            Your AI co-pilot. Ask about deal flow, explore startups, or get market intelligence.
          </p>
        </div>
        ...
        <StartupKevinChatCard
          token={token}
          emptyHint="Ask Kevin about deal flow, startups, sectors, or investment strategies."
        />
